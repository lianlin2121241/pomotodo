...
angular.module('myApp')
   ...
   */
  .constant('JQ_CONFIG', {
      datetimepicker: ["scripts/vendor/smalot-bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css",
                          'scripts/vendor/smalot-bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js',
                          'scripts/vendor/smalot-bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js'],
          ...
          modules: [
              {
                  ...
                  files: [
                      ...
                      'vendor/wijmo/wijmo.angular.min.js'
                  ]
              }
          ]
      });
